import { CardPronostico , Nombre , Grados , Span } from "../../Styled/Components.styled";

const SlidePronostico = ({ datos }) => {

    console.log( datos );

    let horaAux = datos.hora + new Date().getHours() + 1;
    const horaMostrar = ( horaAux >= 24 ) ? horaAux - 24 : horaAux;

    const getSvg = ( numero ) => {
        
        if ( numero.includes('n') ) {
            return (
                <svg xmlns="http://www.w3.org/2000/svg" className="noche" fill="currentColor" viewBox="0 0 16 16">
            ...
            return (
                <svg xmlns="http://www.w3.org/2000/svg" className="sol" fill="currentColor" viewBox="0 0 16 16">
        ...
        } else if ( numero >= 27 && numero <= 50 ) {
            return (
                <svg xmlns="http://www.w3.org/2000/svg" className="lluvia" fill="currentColor" viewBox="0 0 16 16">
    ...
    return (
        <>
            <CardPronostico>
                <Nombre>{ horaMostrar }:00</Nombre>
                <Span>{ getSvg( datos.cielo ) }</Span>
                <Grados>{ datos.temperatura }º</Grados>
                <Grados>{ datos.precipitacion }%</Grados>
                <Grados>{ datos.viento.velocidad } Km/h</Grados>
            </CardPronostico>
        </>
    )
}

export default SlidePronostico;